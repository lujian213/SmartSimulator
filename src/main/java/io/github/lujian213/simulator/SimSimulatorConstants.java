...
public class SimSimulatorConstants {
	...
	public static final String HEADER_NAME_BODY_TYPE = "_Body-Type";
	public static final String HEADER_NAME_JSON_CLASS_NAME = "_JSonObject.classname";
	public static final String HEADER_NAME_JSON_VAR_NAME = "_JSonObject.varname";
	public static final String HEADER_NAME_WAIT = "_Wait.Time";
